<?php
/**
 * This file was part of the PHP_Word_Cloud project.
 * http://github.com/sixty-nine/PHP_Word_Cloud
 * Modified to use a more extensive list of english language stopword list.
 */
...
class FrequencyTable {
  ...
  /**
   * Added code to use a extensive list of stopwords from the english language.
   * Reject stop words and clean up the text before adding to words to frequency table.
   * Reject contractions.
   * 
   * @param unknown $word
   * @param number $count
   ...
   */
   private function insert_word($word, $count = 1,$title=null,$reject=true,$cleanup=true) {
	   	$fh = file_get_contents('stopwords.txt');
	   	$this->rejected_words = explode(',',$fh);
  ...
  private function create_frequency_table($words) {
	 ...
	 * 
	 * @param integer $vertical_freq
	 *        	Frequency of vertical words (0 - 10, 0 = All horizontal, 10 = All vertical)
	 */
	 ...
	 * Future Enhancement: This code does not remove ' within a word
	 * as in a contraction.
	 * 
	 * @param string $word
	 *        	The word to clenup
